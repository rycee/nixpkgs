...
let
  sources = {
    ...
    "vscode-json-languageservice-3.4.12" = {
      ...
      version = "3.4.12";
      src = fetchurl {
        url = "https://registry.npmjs.org/vscode-json-languageservice/-/vscode-json-languageservice-3.4.12.tgz";
        sha512 = "+tA0KPVM1pDfORZqsQen7bY5buBpQGDTVYEobm5MoGtXNeZY2Kn0iy5wIQqXveb28LRv/I5xKE87dmNJTEaijQ==";
      };
    };
...
in
{
  ...
  yaml-language-server = nodeEnv.buildNodePackage {
    ...
    version = "0.7.1";
    src = fetchurl {
      url = "https://registry.npmjs.org/yaml-language-server/-/yaml-language-server-0.7.1.tgz";
      sha512 = "IgJDYDpFpwVu0p8oVwBfpnnNxknVd3qIgBL6reqTQX5nbBhB2vF15KVwbnctYQ7542QM0Omo2LwhJAXykfMezg==";
    };
    dependencies = [
      ...
      sources."vscode-json-languageservice-3.4.12"
