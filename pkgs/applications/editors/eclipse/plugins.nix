...
rec {
  ...
  autodetect-encoding = buildEclipsePlugin rec {
    ...
    srcFeature = fetchurl {
      url = "https://cypher256.github.io/eclipse-encoding-plugin/features/eclipse.encoding.plugin.feature_1.8.3.201610171338.jar";
      sha256 = "09xfn5j6vr9r7n0riqs5ja5ms98ax9pyi3f7irnv80flhzagdv7f";
    };

    srcPlugin = fetchurl {
      url = "https://cypher256.github.io/eclipse-encoding-plugin/plugins/mergedoc.encoding_1.8.3.201610171338.jar";
